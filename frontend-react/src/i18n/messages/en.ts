const messages = {
  ...
  "person_research.replace_hint":
    "You are refining an existing dossier: regenerating will update it in the same meeting folder.",
  ...
  "detail.warn_pdl_auth": "Data provider authentication error: check PDL_API_KEY in `.env`.",
